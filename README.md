...
- **登录态学习**：自动识别设备上网盘登录 Cookie/Token 文件并支持局域网同步
...
到 [Releases](https://github.com/motao123/webtv/releases) 下载最新版本：**v5.5.38**。
...
| 功能 | 说明 |
| --- | --- |
| 登录态学习 | 学习设备上网盘登录 Cookie/Token，自动识别路径，参与局域网同步 |
